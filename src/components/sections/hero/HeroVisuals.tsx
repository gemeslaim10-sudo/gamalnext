                ...
                <div className="relative w-full h-full flex items-center group">
                    ...
                    <div className="relative w-full flex flex-col 2xl:flex-row items-center justify-center 2xl:justify-end gap-6 lg:gap-8 mt-10 sm:mt-12 lg:mt-0">
                        ...
                        <div className="relative z-20 flex-shrink-0 group">
                            ...
                            <div className="relative w-[180px] h-[180px] sm:w-[260px] sm:h-[260px] lg:w-[320px] lg:h-[320px] 2xl:w-[340px] 2xl:h-[340px] rounded-[2.5rem] overflow-hidden border-2 border-slate-700/50 hover:border-blue-500/50 bg-[#0f172a] shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-all duration-500 z-10">
                                <Image
