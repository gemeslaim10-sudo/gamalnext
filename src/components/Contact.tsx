        ...
        <section id="contact" className="py-16 md:py-20 bg-slate-950 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                <Reveal className="text-center mb-12 md:mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">تواصل معي</h2>
                    <p className="text-slate-400">متاح للعمل الحر والوظائف بدوام كامل</p>
                </Reveal>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <Reveal className="stagger-1 space-y-5 md:space-y-6">
                        <div className="glass-card p-6 rounded-2xl flex items-center gap-5 group hover:bg-slate-800/40 transition-colors">
                            ...
                            <div>
                                <h4 className="text-slate-400 font-medium text-xs mb-1">واتساب</h4>
                        ...
                        <div className="glass-card p-6 rounded-2xl flex items-center gap-5 group hover:bg-slate-800/40 transition-colors">
                            ...
                            <div className="overflow-hidden">
                                <h4 className="text-slate-400 font-medium text-xs mb-1">البريد الإلكتروني</h4>
                        ...
                        <div className="glass-card p-6 rounded-2xl flex items-center gap-5 group hover:bg-slate-800/40 transition-colors">
                            ...
                            <div>
                                <h4 className="text-slate-400 font-medium text-xs mb-1">الإقامة</h4>
                    ...
                    <Reveal className="stagger-2 glass-card p-8 rounded-3xl relative overflow-hidden">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-8">أرسل رسالة مباشرة</h3>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label htmlFor="name" className="text-slate-300 text-sm font-medium pr-1">الاسم الكريم</label>
                                <input type="text" id="name" name="name" required className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all placeholder:text-slate-600" placeholder="اكتب اسمك هنا..." />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="message" className="text-slate-300 text-sm font-medium pr-1">تفاصيل الرسالة</label>
                                <textarea id="message" name="message" required rows={5} className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all resize-none placeholder:text-slate-600" placeholder="كيف يمكنني مساعدتك في مشروعك القادم؟"></textarea>
                            </div>
